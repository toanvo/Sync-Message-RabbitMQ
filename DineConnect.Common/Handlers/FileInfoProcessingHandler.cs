...
{
    public class ClientFileInfoProcessingHandler : IProcessingHandler<FileInfo>
    {
        ...
        public ClientFileInfoProcessingHandler(IConfiguration configuration, ISendContentFileToQueueHandler sendContentFileToQueueHandler)
        {
